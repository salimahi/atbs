...
gc = gspread.service_account('tp-etp-reports-dba182a17da0.json')

#Access the spreadsheet where the report will go - AKA "Report Spreadsheet"
REPORT = '1HkreKeAWq5aCi_rONCdlqh9qSQ0fSk1GZUsf2CfYW-M' #pulled from the google sheet URL
...
def extract_worksheet(sheet_id,worksheet_id):
    ...
    df = df.drop(["Client's First Name", "Client's Last Name",'Duration'], errors='ignore', axis=1)
